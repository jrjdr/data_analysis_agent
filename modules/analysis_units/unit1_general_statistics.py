...
class GeneralStatisticsUnit(BaseAnalysisUnit):
    """
    总体数据统计分析单元，负责生成基本统计分析和总体数据概览
    """
...
输出要求:
1. 分析结果应包含关键统计数据和发现
2. 结果应保存到"pngs/analysis_results.txt"
